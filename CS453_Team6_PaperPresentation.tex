...
\section{Automated Systems Testing}
	...
	\begin{frame}{Implementation}
		...
		\begin{itemize}
			...
			\item<+-> Guided and unguided test generation
		\end{itemize}

		\note{
		CGS: ground control system
...
\section{Conclusion \& Future work}
	...
	\begin{frame}{Future work}
		...
		\end{itemize}
		\note{
			Expand HOUSTON for test-suite generation. Targeting subset of bug types promising

			Expand input space by e. g. failing sensors, lost communication

			More powerful specification language to deal with timing of events and model concurrency (consider burden to use)

			Inference using outlier traces to generate high-quality specifications
		}
	\end{frame}
